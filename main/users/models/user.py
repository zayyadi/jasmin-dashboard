...
class User(AbstractBaseUser, PermissionsMixin, TimeStampedModel):
    ...
    is_email = models.BooleanField(_("Is Email Verified"), default=True)
    ...
    mob = models.CharField(
        verbose_name=_("Mobile"), max_length=15, blank=True, validators=[_PHONE_REGEX]
    )
    ...
    fax = models.CharField(
        verbose_name=_("Fax"), max_length=15, blank=True, validators=[_PHONE_REGEX]
    )
    ...
    def get_dict(self):
        return {
            ...
            "img": (
                ...
                if self.img
                else {"url": settings.DEFAULT_USER_AVATAR, "name": "user"}
            ),
