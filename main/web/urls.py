...
urlpatterns = [
    ...
    path("mointerceptor/", mointerceptor_view, name="mointerceptor_view"),
    path(
        "mointerceptor/manage/",
        mointerceptor_view_manage,
        name="mointerceptor_view_manage",
    ),
    path("mtinterceptor/", mtinterceptor_view, name="mtinterceptor_view"),  # noqa: F405
    path(
        "mtinterceptor/manage/",
        mtinterceptor_view_manage,
    ...
    path(
        "submit_logs/manage/", submit_logs_view_manage, name="submit_logs_view_manage"
    ),
    path("submit_logs/", submit_logs_view, name="submit_logs_view"),  # noqa: F405
